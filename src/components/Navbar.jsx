...
import {
  BookText, HelpCircle, ShoppingCart, LogOut, Moon, Sun, Globe, Layers,
  ChevronRight, Bell, Settings, Eye, Play
} from 'lucide-react';
import { C } from '../constants/theme.js';

export default function Navbar({ setPage, userRole, onLogout, cartCount, openCart, addToast, darkMode, setDarkMode, lang, setLang }) {
