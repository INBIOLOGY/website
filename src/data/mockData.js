...
export const COURSES = [
  ...
  },
  {
    ...
    lessons: [
      ...
      { id: 'l2', title: 'EP 2: ตะลุยข้อสอบจริง A-Level ชุดที่ 1 (ข้อ 1-25) + เฉลยรายละเอียดชี้จุดลวง', duration: 65 },
      { id: 'l3', title: 'EP 3: ตะลุยข้อสอบจริง A-Level ชุดที่ 1 (ข้อ 26-50) + เฉลยรายละเอียดชี้จุดลวง', duration: 65 },
