...
const REVIEWS = [
  ...
  {
    id: 'rev-5',
    name: 'พี่มุก (กัลยารัตน์)',
    text: 'ประทับใจความใส่ใจของพี่ต้นมากค่ะ ชีทเรียนสวย อ่านเข้าใจง่าย ภาพประกอบช่วยให้เห็นกลไกของเซลล์ชัดเจนมาก ไม่ต้องนั่งจินตนาการเอง สอบเข้าทันตแพทย์ใช้คะแนนชีวะสูงมาก คอร์สนี้ช่วยดึงเกรดและคะแนนสอบพุ่งสมใจเลยค่ะ',
    score: 'คณะทันตแพทยศาสตร์ จุฬาลงกรณ์มหาวิทยาลัย',
    avatar: './student_mook.jpg',
    imagePosition: 'center top',
    school: 'โรงเรียนเตรียมอุดมศึกษา',
    course: 'Bio Intensive Complete Set & Mock Exam'
  },
  {
    id: 'rev-6',
    name: 'พี่พีท (ธนภัทร)',
    text: 'คอร์ส สอวน. ชีวะ และ Intensive ของพี่ต้นเข้มข้นมากครับ สอนลึกถึงกลไกทางสรีรวิทยาและชีวเคมีอย่างแม่นยำ เหมาะกับคนที่อยากสอบติดค่าย 1 ค่าย 2 สอวน. และเตรียมพร้อมสำหรับสายวิทยาศาสตร์สุขภาพครับ แนะนำเพื่อนๆ ทุกคนเลยครับ',
    score: 'คณะเภสัชศาสตร์ มหาวิทยาลัยมหิดล',
    avatar: './student_pete.jpg',
    imagePosition: 'center top',
    school: 'โรงเรียนสวนกุหลาบวิทยาลัย',
    course: 'สอวน. ชีววิทยา ค่าย 1 Mastery'
  },
  {
    id: 'rev-7',
    name: 'พี่ฟ้า (ศิริพร)',
    text: 'เคยเรียนชีวะแบบท่องจำแล้วลืมเร็วมาก พอมาเรียนกับพี่ต้น ได้เข้าใจคอนเซ็ปต์ตั้งแต่รากฐาน เทคนิคเพลงช่วยจำติดหัวตลอดเวลาทำข้อสอบจริง ทำให้ทำข้อสอบเร็วขึ้นและมีเวลาเหลือตรวจทาน ดีใจมากๆ ที่ได้เป็นศิษย์พี่ต้นค่ะ',
    score: 'คณะแพทยศาสตร์ศิริราชพยาบาล',
    avatar: './student_fah.jpg',
    imagePosition: 'center top',
    school: 'โรงเรียนสามเสนวิทยาลัย',
    course: 'Bio Intensive I - VI & A-Level'
  },
  {
    id: 'rev-8',
    name: 'พี่กันต์ (กิตติภูมิ)',
    text: 'โจทย์แนววิเคราะห์ A-Level และ สอวน. ยุคใหม่ต้องอาศัยการคิดวิเคราะห์ ไม่ใช่แค่จำเนื้อหา พี่ต้นพาตะลุยโจทย์แบบละเอียด ชี้จุดหลอกที่คนมักพลาดบ่อยๆ คะแนนชีวะของผมติดท็อปประเทศได้ส่วนสำคัญมาจากเทคนิคของพี่ต้นเลยครับ',
    score: 'คณะแพทยศาสตร์โรงพยาบาลรามาธิบดี',
    avatar: './student_gun.jpg',
    imagePosition: 'center top',
    school: 'โรงเรียนมหิดลวิทยานุสรณ์',
    course: 'A-Level Biology Mastery 100%'
  }
];
